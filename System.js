...
client.channels.find('id', '539825183977111553').setName(`Time - ${hours} : ${ReBeeL} : ${ReBeeeL} ${suffix}`) 
client.channels.find('id', '539825238263726093').setName(`Date : ${Codes} - ${CodeS} - ${CoDeS}`)
}, 1000);
});
